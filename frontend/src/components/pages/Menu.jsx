    ...
    <>
      ...
      <section className="restaurant-info">
        ...
        <p className="restaurant-address">
          131 North Orange Avenue, Suite 103, Orlando, FL
        </p>
      ...
      <div className="order-toggle">
        <button
          className={
            orderType === "delivery" ? "toggle-btn active" : "toggle-btn"
          }
        ...
        <button
          className={
            orderType === "pickup" ? "toggle-btn active" : "toggle-btn"
          }
      ...
      <div className="order-info">
        <div className="order-info-row">
          ...
          <span className="info-text">
            Pickup from 131 North Orange Avenue, Suite 103...
          </span>
          <span className="info-arrow">&#8250;</span>
        </div>
        <div
          className="order-info-row timing-row"
